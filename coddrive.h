/************************************************************************
 * coddrive.h - Header for coddrive
 *
@(#) $Name$ $Id$
*/
#ifndef CODDRIVE_H
...
void    codlog          ANSIARGS((int argc, char **argv));
void coddrive_connect ANSIARGS((LINK * link));
...
CODDRIVE_BASE coddrive_base;      /* Global configuration information */
#ifdef RAW
